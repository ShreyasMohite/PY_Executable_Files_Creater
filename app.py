...
class File:
    def __init__(self,root):
        self.root=root
        self.root.title("Executable File Extention")
        self.root.geometry("500x400")
        self.root.iconbitmap("logo64.ico")
...
#======================================================================================#
        ...
        def clear():
            ...
            filextention.set("Select Executable File Extention")
        ...
        def genrate():
            try:
                if path.get()!="":
                    ...
                    if filextention.get()!="Select Executable File Extention":
                        if filename.get()!="":

                            if filextention.get()=="Android package file" and filename.get()!="":
                                touch.touch(a+"/{}.apk".format(filename.get()))
                            
                            if filextention.get()=="Batch file" and filename.get()!="":
                                touch.touch(a+"/{}.bat".format(filename.get()))
                        

                            if filextention.get()=="Binary file" and filename.get()!="":
                                touch.touch(a+"/{}.bin".format(filename.get()))
                            

                            if filextention.get()=="Perl script file" and filename.get()!="":
                                touch.touch(a+"/{}.pl".format(filename.get()))

                            if filextention.get()=="MS-DOS command file" and filename.get()!="":
                                touch.touch(a+"/{}.com".format(filename.get()))

                            if filextention.get()=="Executable file" and filename.get()!="":
                                touch.touch(a+"/{}.exe".format(filename.get()))
                            
                            if filextention.get()=="Windows gadget" and filename.get()!="":
                                touch.touch(a+"/{}.gadget".format(filename.get()))

                            if filextention.get()=="Java Archive file" and filename.get()!="":
                                touch.touch(a+"/{}.jar".format(filename.get()))

                            if filextention.get()=="Windows installer package" and filename.get()!="":
                                touch.touch(a+"/{}.msi".format(filename.get()))

                            if filextention.get()=="Python file" and filename.get()!="":
                                touch.touch(a+"/{}.py".format(filename.get()))

                            if filextention.get()=="Windows Script File" and filename.get()!="":
                                touch.touch(a+"/{}.wsf".format(filename.get()))
...
#======================================================================================#
        ...
        fileselect=["Android package file","Batch file","Binary file",\
                    "Perl script file","MS-DOS command file","Executable file",\
                    "Windows gadget","Java Archive file","Windows installer package","Python file","Windows Script File"]
        fileselect_combo=Combobox(firstframe,values=fileselect,font=('arial',12),width=25,state="readonly",textvariable=filextention)
        fileselect_combo.set("Select Executable File Extention")
